...
<body id="app" class="maintenance-page">
    <header class="site-header">
        <a href="#" class="brand-main">
            ...
            <img src="{{asset('/assets/admin/img/logo-mobile.png')}}" id="logo-mobile" alt="Laraspace Logo"
                class="d-md-none">
        </a>
        ...
        <div class="row">
            <div class="col-sm-12 text-sm-center">
                ...
                <div class="social-icons">
                    ...
                    <a href="/auth/google" class="btn btn-default text-danger btn-icon"><i
                            class="icon-fa icon-fa-google"></i></a>
                    <a href="/auth/github" class="btn btn-default btn-icon text-default"><i
